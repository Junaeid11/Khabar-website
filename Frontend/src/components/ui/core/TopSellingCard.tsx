...
const TopSellingCard = ({ meal }: { meal: IMeal }) => {
  return (
    ...
    >
      <Card className="p-4 shadow-xl rounded-lg bg-white">
        {/* Meal Image */}
        <CardHeader className="relative p-0 h-48 overflow-hidden rounded-lg">
          ...
          {meal.category && (
            <div className="absolute top-2 left-2 bg-white p-2 rounded-full shadow-md">
              <Image
                src={meal.category.icon ||"https://psediting.websites.co.in/obaju-turquoise/img/product-placeholder.png"
           }
                width={30}
                height={30}
        ...
        <CardContent className="mt-3">
          ...
          <div className="flex justify-between items-center mt-2">
            ...
            <div className="flex items-center gap-1 text-yellow-500">
              ...
              <span className="text-sm font-medium">{meal.rating} ({meal.ratingCount})</span>
